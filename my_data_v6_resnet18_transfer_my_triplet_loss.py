...
# model
from models import resnet50, resnet18, MyTripletLoss, resnet18_centerloss
...
parser.add_argument('--train_batch', default=48, type=int, metavar='N',
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_transfer_480_my_triplet_loss', type=str, metavar='PATH',
...
def train(train_iter, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_iter):
        ...
        loss_t = criterion_t(feat, targets, per_outputs)
        loss += loss_t
