...
# model
from models import resnet50, resnet18, densenet_121, alexnet
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_alexnet', type=str, metavar='PATH',
