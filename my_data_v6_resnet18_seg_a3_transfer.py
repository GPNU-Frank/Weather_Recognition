...
# model
from models import resnet50, resnet18, resnet18_seg_a3
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_seg_a3_transfer', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_seg_a3(pretrained=True)
