...
# model
from models import resnet50, resnet18, resnet18_seg_a2
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_seg_a2_transfer', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_seg_a2(pretrained=True)
    ...
    # optimizer
    seg_layer4_params = list(map(id, model.seg_layer4.parameters()))
    fc_params = list(map(id, model.fc.parameters()))
    base_params = filter(lambda p: id(p) not in seg_layer4_params + fc_params,
                            model.parameters())

    optimizer = optim.SGD([{'params': base_params},
                            {'params': model.seg_layer4.parameters(), 'lr': 0.005},
