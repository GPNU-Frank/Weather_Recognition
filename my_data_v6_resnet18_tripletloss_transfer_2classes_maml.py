...
parser.add_argument('--test-batch', default=6, type=int, metavar='N',
                help='test batchsize')
parser.add_argument('--mwd-batch', default=18, type=int, metavar='N',
                help='test batchsize')
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_tripletloss_transfer_480_maml', type=str, metavar='PATH',
