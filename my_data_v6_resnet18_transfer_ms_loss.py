...
from models.ms_loss import MultiSimilarityLoss
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_transfer_480_ms_loss', type=str, metavar='PATH',
...
def main():
    ...
    global criterion_t
    criterion_t = MultiSimilarityLoss()
