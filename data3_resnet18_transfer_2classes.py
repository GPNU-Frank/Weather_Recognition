...
parser.add_argument('--test-path', default="G:\\vscode_workspace\\Weather_Recognition\\data3\\val_imgs_3_2classes\\")
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/data3_resnet18_transfer_480_2classes', type=str, metavar='PATH',
