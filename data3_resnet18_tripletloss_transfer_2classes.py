...
parser.add_argument('--train-path', default="G:\\vscode_workspace\\Weather_Recognition\\data3\\train_2classes\\")
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/data3_tripletloss_transfer_480_2classes', type=str, metavar='PATH',
