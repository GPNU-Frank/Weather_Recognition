...
parser.add_argument('--train-path', default="G:\\vscode_workspace\\Weather_Recognition\\data_v6_new_2classes\\train2\\")
...
parser.add_argument('--test-batch', default=3, type=int, metavar='N',
                help='test batchsize')
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_new_resnet18_tripletloss_transfer_480_2classes', type=str, metavar='PATH',
