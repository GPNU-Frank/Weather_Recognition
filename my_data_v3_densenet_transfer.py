...
parser.add_argument('--schedule', type=int, nargs='+', default=[3, 6, 9, 12, 15],
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v3_densenet121_transfer', type=str, metavar='PATH',
