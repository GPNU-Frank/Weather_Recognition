...
# model
from models import resnet50, resnet18, MyTripletLoss, resnet18_centerloss, FocalLoss
...
parser.add_argument('--gap', default=0.2, type=float,
                metavar='W', help='my triplet loss gap')

# parser.add_argument('--pretrained', default='pretrainedmodels/vgg_msceleb_resnet50_ft_weight.pkl', type=str, metavar='PATH', 
#                     help='path to latest checkpoint (default: none)')

# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_transfer_480_focal_loss', type=str, metavar='PATH',
...
def main():
    ...
    # global criterion_t
    # criterion_t = MyTripletLoss(margin=1.0, gap=args.gap)
