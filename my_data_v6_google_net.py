...
# model
from models import resnet50, resnet18, densenet_121, vgg_13, google_net
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_google_net', type=str, metavar='PATH',
