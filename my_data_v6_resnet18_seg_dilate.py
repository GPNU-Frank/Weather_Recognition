...
# model
from models import resnet50, resnet18, resnet18_seg, FocalLoss, resnet18_seg_dilate
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_seg_dilate', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_seg_dilate(pretrained=True)
    if use_cuda:
        model = model.cuda()
