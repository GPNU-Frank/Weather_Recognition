...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_transfer_480_triplet_loss_ba', type=str, metavar='PATH',
...
def train(train_iter, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_iter):
        ...
        with torch.autograd.set_detect_anomaly(True):
            ...
            loss_t = batch_all_triplet_loss(targets, feat, 1)[0]
            loss += loss_t
