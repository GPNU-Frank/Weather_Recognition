...
# model
from models import resnet50, resnet18, resnet18_dilated
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_dilated', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_dilated(pretrained=True)
