...
# model
from models import resnet50, resnet18, resnet18_dilate
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v5_resnet18_dilate', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_dilate(pretrained=True)
