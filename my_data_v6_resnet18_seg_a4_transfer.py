...
from models.resnet_seg_a4 import resnet18_seg_a4
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_seg_a4_transfer', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_seg_a4(pretrained=True)
