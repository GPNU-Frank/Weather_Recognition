...
if __name__ == '__main__':
    ...
    for epoch in range(0, epochs):
        ...
        print ('=' * 20)
        train_loader = MyDataTriplet(root_path='D:\\flk\\Weather_Recognition\\data_split_reduce_v6\\test\\',
                                  batch_size=batch_size, num_workers=1, transforms=transform)
