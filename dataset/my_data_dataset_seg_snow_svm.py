...
class MyDataSegSnowSVM(Dataset):
...
if __name__ == '__main__':
    ...
    train_dataset = MyDataSegSnowSVM(root_path=train_path, transform=transform)
    test_dataset = MyDataSegSnowSVM(root_path=test_path, transform=transform)
