...
if __name__ == '__main__':
    ...
    train_path = "G:\\vscode_workspace\\Weather_Recognition\\data3\\train\\"
    test_path = "G:\\vscode_workspace\\Weather_Recognition\\data3\\test\\"
    ...
    train_dataset = MyDataDiffSize(root_path=train_path, transform=transform)
    train_iter = torch.utils.data.DataLoader(train_dataset, 4, shuffle=True, collate_fn=)
