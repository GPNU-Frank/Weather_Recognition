...
# model
from models import resnet50, resnet50_adv, FocalLoss
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/mwd_resnet50_adv', type=str, metavar='PATH',
...
def main():
    ...
    dataset = MWD_Adv(root_path=args.root_path, transform=valid_transform)
