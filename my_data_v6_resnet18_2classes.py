...
# model
from models import resnet50, resnet18, FocalLoss, resnet18_2classes
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_2classes', type=str, metavar='PATH',
...
def main():
    ...
    # model
    model = resnet18_2classes(pretrained=True)
