...
# pyramid pooling
class PPM(nn.Module):
    def __init__(self, num_class=150, fc_dim=512,
        ...
        self.last_conv = nn.Conv2d(512 * 5, 512, kernel_size=1, bias=False)
    ...
    def forward(self, conv_out, segSize=None):
        ...
        x = self.last_conv(ppm_out)

        return x

def resnet18_ppm(pretrained=False, **kwargs):
