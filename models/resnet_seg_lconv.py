...
class LocalBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        self.convf1_1 = nn.Conv2d(in_channels=inplanes, out_channels=inplanes//2, kernel_size=(1, 1), stride=1)
        self.bnf1_1 = nn.BatchNorm2d(planes)
        self.conv3_3 = nn.Conv2d(in_channels=inplanes//2, out_channels=inplanes//2, kernel_size=(3, 3), stride=1, padding=1)
        self.bn3_3 = nn.BatchNorm2d(planes)
        self.conv3_1 = nn.Conv2d(in_channels=inplanes//2, out_channels=inplanes//2, kernel_size=(3, 1), stride=1, padding=1)
        self.bn3_1 = nn.BatchNorm2d(planes)
        self.conv1_3 = nn.Conv2d(in_channels=inplanes//2, out_channels=inplanes//2, kernel_size=(1, 3), stride=1, padding=1)
        self.bn1_3 = nn.BatchNorm2d(planes)
        self.conl1_1 = nn.Conv2d(in_channels=inplanes//2, out_channels=planes, kernel_size=(1, 1), stride=1)
        self.relu = nn.ReLU()
