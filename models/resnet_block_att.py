...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=5):
        ...
        self.conv3_1 = nn.Conv2d(256, 256, 1, bias=False)
    ...
    def forward(self, x):
        ...
        att_x = x * ca_x * sa_x
        att_x = self.conv3_1(att_x)
        att_x = nn.AdaptiveMaxPool2d(1)(att_x)
        att_x = att_x.view(x.size(0), -1)
...
def resnet18_block_att_2classes(pretrained=False, **kwargs):
...
def main():
    ...
    model = resnet18_block_att(pretrained=True)
