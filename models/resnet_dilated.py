...
def resnet18_dilated(pretrained=False, **kwargs):
    ...
    if pretrained:
        # pretrained_state_dict = torch.load("./pretrained/encoder_epoch_20.pth")
        # print(pretrained_state_dict.keys())
        pretrained_state_dict = load_url(model_urls['resnet18'])
    ...
    model = ResnetDilated(model, dilate_scale=8)
