...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=6):
        ...
        self.fc = nn.Linear(512 * block.expansion + 16 + 16, num_classes)
    ...
    def forward(self, x, contrast, hist):
        ...
        # 传统特征
        x_h = self.fc_hist(hist)
        x = torch.cat([x, contrast, x_h], dim=1)
        x = self.fc(x)
