...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=5):
        ...
        # self.last_conv = nn.Conv2d(64 + 128 + 256 + 512, 512, kernel_size=1, bias=False)

        self.last_conv = nn.Sequential(
            nn.Conv2d(64 + 128 + 256 + 512, 512, kernel_size=1, bias=False),
            nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Dropout2d(0.2)
        )
...
def resnet18_layercat(pretrained=False, **kwargs):
