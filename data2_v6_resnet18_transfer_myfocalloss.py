...
# model
from models import resnet50, resnet18, FocalLoss, MyFocalLoss
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/data2_resnet18_transfer_480_my_focal_loss', type=str, metavar='PATH',
