...
from models.triplet_loss_normal import TripletLoss
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_resnet18_transfer_480_triplet_loss_normal', type=str, metavar='PATH',
