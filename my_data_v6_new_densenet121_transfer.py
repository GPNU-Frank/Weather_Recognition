...
# model
from models import resnet50, resnet18, FocalLoss, densenet_121
...
parser.add_argument('--pretrained-path', default="G:\\vscode_workspace\\Weather_Recognition\\checkpoints\\mwd_densenet121\\04_20_21_15_fold_0_model_best.pth.tar")
...
# checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints/my_data_v6_new_densenet121_transfer_480', type=str, metavar='PATH',
